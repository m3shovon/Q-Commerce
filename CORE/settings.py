...
SECRET_KEY = 'django-insecure-6aew*zr)c3*b!^)+i*#pj)#w&*+)efv=vi5=^74t+8dba5aq$3'
...
# SUBJECT ="Email Confirmation Mail From The ICT HUB"
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Tuki Tuki",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Tuki Tuki",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Tuki Tuki",
    ...
    "welcome_sign": "Welcome to the Cloud Q-Commerce",
